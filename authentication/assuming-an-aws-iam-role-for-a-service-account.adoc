...
* For general information about webhook admission plugins for OpenShift, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws_classic_architecture/4/html/architecture/admission-plug-ins#admission-webhooks-about_admission-plug-ins[Webhook admission plugins] in the {product-title} documentation.
